...
export default function Toastbasic(){
    ...
    let toastbasicComp = (
                <div className="border border-gray-100 rounded-xl bg-white" style={{"width":"348px", "height":"auto", "box-shadow": "0px 4px 10px 3px rgba(0, 0, 0, 0.2)"}}>
                    ...
                    <div className="px-5 pb-4">
                        <div className="w-full">
                            <div><h4 className={"p-0 m-0 font-normal text-sm leading-5 text-black " + toastbasicState.selectedFont}>Descriptive text</h4></div>
                            <div><p className={"p-0 m-0 font-normal text-sm leading-5 text-gray-500 " + toastbasicState.selectedFont}>Assistive text</p></div>
                        </div>
                    </div>
                </div>
    )
