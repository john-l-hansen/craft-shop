...
export default function ElevatedButton() {
  ...
  let elevatedButtonComp = (
    <div>
      ...
      <div className="flex items-center justify-center">
        <button
          className={
            ...
            elevatedButtonState.selectedColor +
            ' ' +
            elevatedButtonState.selectedFont
          }
          style={{
            'box-shadow':
      ...
      <div className="mt-5 flex items-center justify-center">
        ...
        <button
          className="ml-3 flex items-center justify-center rounded-lg py-2 px-6 text-sm font-medium leading-5 text-gray-300 disabled:bg-gray-100 dark:bg-gray-900 dark:text-gray-700 "
          disabled
        >
          <div>
          <svg width="12" height="12" class="fill-current" viewBox="0 0 12 12" fill="none"
  ...
  let elevatedButtonCompString =
    ...
    ' ' +
    elevatedButtonState.selectedFont +
    '" style="box-shadow: 0px 1px 2px rgba(0, 0, 0, 0.3), 0px 1px 3px 1px rgba(0, 0, 0, 0.15)">Enabled</button>'

  let elevatedButtonCompStringTwo =
    '<button class="py-2 px-6 flex justify-center items-center rounded-lg font-medium text-gray-800 leading-5 text-sm ' +
    elevatedButtonState.selectedColor +
    ' ' +
    elevatedButtonState.selectedFont +
  ...
  let elevatedButtonCompStringThree =
    '<button class="py-2 px-6 flex justify-center items-center rounded-lg font-medium text-gray-800 leading-5 text-sm ' +
    elevatedButtonState.selectedColor +
    ' ' +
    elevatedButtonState.selectedFont +
