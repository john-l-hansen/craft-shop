    ...
    let uploaderwideComp = (
            <div>
                <div className="flex w-[325px] items-center justify-center">
                    <label for="dropzone-file" className="flex w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-200 hover:dark:border-gray-400 transition hover:border-solid dark:text-white hover:bg-gray-50 dark:hover:bg-gray-900 h-[148px] py-8">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <div className={"my-3 text-sm " + uploaderwideState.selectedFont}>Drag and drop or click to upload</div>
                            <div className={"text-xs text-gray-700 dark:text-gray-200 " + uploaderwideState.selectedFont}>CSV or TXT</div>
                        </div>
                ...
                <div className="flex w-[325px] items-center justify-center">
                    <label for="dropzone-file" className="dark:bg-gray-800 bg-gray-100 flex border-2 border-dashed border-gray-200 dark:border-gray-700 w-full cursor-not-allowed flex-col items-center justify-center h-[148px] rounded-lg py-8">
                        <div className="flex flex-col items-center justify-center">
                        <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.5 11V14H2.5V11H0.5V14C0.5 15.1 1.4 16 2.5 16H14.5C15.6 16 16.5 15.1 16.5 14V11H14.5ZM3.5 5L4.91 6.41L7.5 3.83V12H9.5V3.83L12.09 6.41L13.5 5L8.5 0L3.5 5Z" fill=""/>
                        </svg>
                        <div className={"my-3 text-gray-400 dark:text-gray- dark:text-gray-600 text-sm " + uploaderwideState.selectedFont}>Drag and drop or click to upload</div>
                        <div className={"text-xs text-gray-300  dark:text-gray-600 " + uploaderwideState.selectedFont}>CSV or TXT</div>
                        </div>
                ...
                <div className="flex w-[325px] items-center justify-center">
                    <label for="dropzone-file" className="flex w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed hover:border-solid border-red-200 hover:bg-red-50 transition h-[148px] py-8">
                        <div className="flex flex-col items-center dark:text-white justify-center">
                        <svg class="fill-current" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18.667 15V18H6.22251V15H4.14844V18C4.14844 19.1 5.08177 20 6.22251 20H18.667C19.8077 20 20.741 19.1 20.741 18V15H18.667ZM7.25955 9L8.72177 10.41L11.4077 7.83V16H13.4818V7.83L16.1677 10.41L17.6299 9L12.4447 4L7.25955 9Z" fill=""/>
                        </svg>
                ...
                <div className="flex w-[325px] mt-3">
                    <div className="bg-gray-50 dark:bg-gray-900 flex w-full cursor-pointer flex-col justify-between rounded-lg transition p-4">
                        <div className="flex justify-between">
                            <div className="flex">

                            <svg class="hidden dark:block" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="36" height="36" rx="8" fill="#444545"/>
                            <path d="M15.17 12L17.17 14H26V24H10V12H15.17ZM16 10H10C8.9 10 8.01 10.9 8.01 12L8 24C8 25.1 8.9 26 10 26H26C27.1 26 28 25.1 28 24V14C28 12.9 27.1 12 26 12H18L16 10Z" fill="#84889B"/>
                            </svg>


                            <svg class='dark:hidden' width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="ml-3">
                                <div className={"text-sm text-black dark:text-white " + uploaderwideState.selectedFont}>File_name.type</div>
                                <div className={"dark:text-gray-600 text-xs text-gray-300 " + uploaderwideState.selectedFont}>#KB - 23 seconds left</div>
                            </div>
                            </div>
                            <div className="flex flex-col">
                            <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.8337 5.34166L14.6587 4.16666L10.0003 8.825L5.34199 4.16666L4.16699 5.34166L8.82533 10L4.16699 14.6583L5.34199 15.8333L10.0003 11.175L14.6587 15.8333L15.8337 14.6583L11.1753 10L15.8337 5.34166Z" fill=""/>
                            </svg>
                            <div className={"dark:text-gray-600 text-xs text-gray-300 " + uploaderwideState.selectedFont}>25%</div>
                            </div>
                        </div>
                        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full mt-3">
                            <div className="w-3/12 bg-blue-gr dark:bg-gray-50 h-1 rounded-full"></div>
                        </div>
                    </div>
                </div>
