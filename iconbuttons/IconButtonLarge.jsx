...
export default function IconButtonLarge(){
    const [iconbuttonlargeState, setIconbuttonlargeState] = useState({
        showColor: false,
    ...
    const toggleColor = (e) => {
        ...
        setIconbuttonlargeState({
            ...iconbuttonlargeState,
            showColor:!iconbuttonlargeState.showColor,
        })
    ...
    let iconbuttonlargeComp = (
      <div>
        ...
        let iconbuttonlargeCompString = '<button class="w-12 h-12 flex justify-center items-center rounded-xl font-medium text-white leading-5 text-sm bg-gray-100 hover:bg-gray-200 focus:bg-gray-200 active:bg-gray-400" style="boxShadow: 0px 4px 10px 3px rgba(0, 0, 0, 0.2)">\n'+
    ...
    return(
        <>
            ...
            iconbuttonlargeComp={iconbuttonlargeComp} 
            iconbuttonlargeCompString={iconbuttonlargeCompString}
            showColor={iconbuttonlargeState.showColor} 
            selectedColor={iconbuttonlargeState.selectedColor}
